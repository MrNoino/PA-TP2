...
import tp2.controller.ManageLiteraryStyles;
...
public class AuthorViews {
        ...
        do {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    Book book = manageBooks.getBookById(Server.getLoggedUser().getId(), id);
                    title = InputReader.readString("Título: ");
        ...
        do {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    books = manageBooks.getBooksBySubmissionDate(Server.getLoggedUser().getId(),
                            InputReader.readDate("Data de submisssão a pesquisar: ", "dd-mm-yyyy"));
                    break;

                case 6:
                    books = manageBooks.getBooksByIsbn(Server.getLoggedUser().getId(), InputReader.readString("ISBN a pesquisar: "));
                    break;
                case 0:
                    continue;
                default:
    ...
    private void showListBooksPaginatedMenu(String orderField, String sortOrder) {
        ...
        do {
            ...
            ArrayList<Book> books = new ManageBooks().getBooks(Server.getLoggedUser().getId(), orderField, sortOrder, page);
            if (books.isEmpty()) {
        ...
        do {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    ManageBooks manageBooks = new ManageBooks();
                    ArrayList<Book> books = manageBooks.getBooksByAuthor(Server.getLoggedUser().getId());
                    ...
                    boolean success = manageReviews.insertReview(bookId, Server.getLoggedUser().getId());
    ...
    private void showReviewRequestsListMenu() {
        ...
        do {
            ...
            ManageReviews manageReviews = new ManageReviews();
            long userId = Server.getLoggedUser().getId();
    ...
    private void showReviewRequestsListPaginatedMenu(String sortType) {
        ...
        do {
            ...
            ArrayList<Review> reviews = new ManageReviews().getReviewsByAuthor(Server.getLoggedUser().getId(), sortType, page);
            System.out.println("\tPágina " + page + "\n");
    ...
    private void showReviewRequestsSearchedMenu(String searchField){
        ...
        switch (searchField.toLowerCase()) {
            case "date":
                reviews = new ManageReviews().getReviewsByDate(Server.getLoggedUser().getId(), InputReader.readDate("Data de Submissão a pesquisar: ", "dd-MM-yyyy"));
                break;
            case "title":
                reviews = new ManageReviews().getReviewsByTitle(Server.getLoggedUser().getId(), InputReader.readString("Título a pesquisar: "));
                break;
            case "status":
                reviews = new ManageReviews().getReviewsByStatus(Server.getLoggedUser().getId(), InputReader.readString("Estado a pesquisar: "));
                break;
            default:
    ...
    private void showUpdateProfileMenu() {
        ...
        Author author = manageAuthors.getAuthor(Server.getLoggedUser().getId());
        ...
        if (manageAuthors.updateAuthor(new Author(Server.getLoggedUser().getId(),
                name,
                username,
                password,
                email,
