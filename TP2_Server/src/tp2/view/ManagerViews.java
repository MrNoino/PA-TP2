...
import tp2.controller.ManageLicenses;
import tp2.controller.ManageLiteraryStyles;
import tp2.controller.ManageLogs;
import tp2.controller.ManageManagers;
import tp2.controller.ManageReviewers;
import tp2.controller.ManageUsers;
import tp2.model.Author;
import tp2.model.License;
import tp2.model.LiteraryStyle;
import tp2.model.Log;
import tp2.model.Manager;
import tp2.model.Reviewer;
...
public class ManagerViews {
    ...
    private void showUpdateProfileMenu() {
        ...
        Manager manager = manageManagers.getManager(Server.getLoggedUser().getId());
        ...
        if (manageManagers.updateManager(new Manager(Server.getLoggedUser().getId(),
                name,
                username,
                password,
                email,
